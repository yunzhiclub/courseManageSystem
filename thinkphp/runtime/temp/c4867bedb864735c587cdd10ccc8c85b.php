<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:91:"D:\xampp\htdocs\beautifulArtical\thinkphp\public/../application/index\view\detail\edit.html";i:1505293679;s:85:"D:\xampp\htdocs\beautifulArtical\thinkphp\public/../application/index\view\index.html";i:1505293116;}*/ ?>
<!DOCTYPE html>
<html lang="zh-cn">
        ...
        <div class="row">
            ...
            <div class="row">
                <div>
                    ...
                    <form action="<?php echo url('update', ['id' => $articleId,'planId'=>$plan->id]); ?>" method="post">
                        <div id="myTabContent" class="tab-content">
                            <div class="tab-pane fade in active" id="firstform">
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input type="date" class="form-control" name="travelDate" placeholder="出行日期" value="<?php echo $plan->travel_date; ?>" />
                                    </div>
                                </div>
                                <div class="control-group">
                                    <label class="control-label" for="peopleNum">出行人数</label>
                                    <div class="controls">
                                        <input type="text" class="form-control" name="peopleNum" placeholder="出行人数" value="<?php echo $plan->people_num; ?>" />
                                    </div>
                                </div>
                                <div class="control-group">
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" class="form-control" name="totalCost" placeholder="总费用" value="<?php echo $plan->total_cost; ?>" />
                                    </div>
                                </div>
                                <div class="control-group">
                                    <label for="lastPayTime">最晚付款时间</label>
                                    <div class="controls">
                                        <input type="date" class="form-control" name="lastPayTime" placeholder="最晚付款时间" value="<?php echo $plan->last_pay_time; ?>" />
                                    </div>
                                </div>
                                <br>
                            </div>
                            <div class="tab-pane fade" id="secondform">
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input type="number" class="form-control" name="dijie_number" placeholder="数量" value="<?php echo $plan->getDetailByType('dijie')->number; ?>" id="numberdijie" onkeyup="jisuan();"/>
                                    </div>
                                </div>
                                <div class="control-group">
                                    <label for="frequency">频次</label>
                                    <div class="controls">
                                        <input type="number" class="form-control" name="dijie_frequency" placeholder="频次" value="<?php echo $plan->getDetailByType('dijie')->frequency; ?>" />
                                    </div>
                                </div>
                                <div class="control-group">
                                    <label for="unitPrice">单价</label>
                                    <div class="controls">
                                        <input type="text" class="form-control" name="dijie_unitPrice" placeholder="单价" value="<?php echo $plan->getDetailByType('dijie')->unit_price; ?>" id="unitdijie" onkeyup="jisuan();" />
                                    </div>
                                </div>
                                <div class="control-group">
                                    <label for="totalPrice">总价</label>
                                    <div class="controls">
                                        <input type="text" class="form-control" name="dijie_totalPrice" placeholder="总价" value="<?php echo $plan->getDetailByType('dijie')->total_price; ?>" id="totaldijie" readonly />
                                    </div>
                                </div>
                                <div class="control-group">
                                    <label for="remark">备注</label>
                                    <div class="controls">
                                        <input type="text" class="form-control" name="dijie_remark" placeholder="备注" value="<?php echo $plan->getDetailByType('dijie')->remark; ?>" />
                                    </div>
                                </div>
                                <br>
                            </div>
                            <div class="tab-pane fade" id="thirdform">
                                ...
                                <div class="control-group">
                                    <label for="number">数量</label>
                                    <div class="controls">
                                        <input type="number" class="form-control" name="zhusu_number" placeholder="数量" value="<?php echo $plan->getDetailByType('zhusu')->number; ?>" id="numberzhusu" onkeyup="jisuan();" />
                                    </div>
                                </div>
                                <div class="control-group">
                                    <label for="frequency">频次</label>
                                    <div class="controls">
                                        <input type="number" class="form-control" name="zhusu_frequency" placeholder="频次" value="<?php echo $plan->getDetailByType('zhusu')->frequency; ?>" />
                                    </div>
                                </div>
                                <div class="control-group">
                                    <label for="unitPrice">单价</label>
                                    <div class="controls">
                                        <input type="text" class="form-control" name="zhusu_unitPrice" placeholder="单价" value="<?php echo $plan->getDetailByType('zhusu')->unit_price; ?>" id="unitzhusu" onkeyup="jisuan();"  />
                                    </div>
                                </div>
                                <div class="control-group">
                                    <label for="totalPrice">总价</label>
                                    <div class="controls">
                                        <input type="text" class="form-control" name="zhusu_totalPrice" placeholder="总价" value="<?php echo $plan->getDetailByType('zhusu')->total_price; ?>" id="totalzhusu" readonly />
                                    </div>
                                </div>
                                <div class="control-group">
                                    <label for="remark">备注</label>
                                    <div class="controls">
                                        <input type="text" class="form-control" name="zhusu_remark" placeholder="备注" value="<?php echo $plan->getDetailByType('zhusu')->remark; ?>" />
                                    </div>
                                </div>
                                <br>
                                <div class="control-group">
