<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:97:"D:\xampp\htdocs\beautifulArtical\thinkphp\public/../application/index\view\material\addindex.html";i:1504748953;s:85:"D:\xampp\htdocs\beautifulArtical\thinkphp\public/../application/index\view\index.html";i:1504748953;}*/ ?>
<!DOCTYPE html>
<html lang="zh-cn">
...
<body class="container">
            ...
            <nav class="navbar navbar-default" role="navigation">
                <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                        ...
                        <ul class="nav navbar-nav">
                            <li <?php if(request()->controller() == 'User'): ?> class="active" <?php endif; ?>><a href="<?php echo url('Material/index'); ?>">素材管理</a></li>
                        </ul>
	...
	<div class="col-md-8 col-md-offset-1" style="margin-top: 60px;margin-bottom: 362px;">
		<h2><span class="glyphicon glyphicon-edit"></span>&nbsp;素材管理</h2>
		<br>
		<form method="post" action="<?php echo url ('add'); ?>" enctype="multipart/form-data">
			...
			<div class="form-group">
				...
				<input type="text" class="form-control" id="SummaryInput" placeholder="描述" name="content">
			</div>
			<div class="form-group">
