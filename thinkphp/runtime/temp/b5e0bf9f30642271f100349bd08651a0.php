<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:89:"D:\xampp\htdocs\beautifulArtical\thinkphp\public/../application/index\view\hotel\add.html";i:1506064901;s:85:"D:\xampp\htdocs\beautifulArtical\thinkphp\public/../application/index\view\index.html";i:1506064901;}*/ ?>
<!DOCTYPE html>
<html lang="zh-cn">
...
<div class="col-md-8 col-md-offset-1" style="margin-top: 60px;min-height: 735px;">
    <div class="row">
        ...
        <form action="<?php echo url($action, ['hotelId' => $hotel->id]); ?>" method="post">
            <div class="form-group">
                <label>名称</label>
                <input type="text" class="form-control" name="designation" placeholder="名称..." value="<?php echo $hotel->designation; ?>">
            </div>
            <div class="form-group">
                <label>目的国家</label>
                <input type="text" class="form-control" name="country" placeholder="所在国家..." value="<?php echo $hotel->country; ?>">
            </div>
            <div class="form-group">
                <label>目的城市</label>
                <input type="text" class="form-control" name="city" placeholder="所在城市..." value="<?php echo $hotel->city; ?>">
            </div>
            <div class="form-group">
                <label>星级</label>
                <div>
                    <label style="margin-right: 15px;" for="1">
                        <input id="1" class="radio-check" type="radio" name="star_level" value="3星级" <?php if($starLevel == '3星级'): ?>checked="checked"<?php endif; ?>>3星级</label>
                    <label style="margin-right: 15px;" for="2">
                        <input id="2" class="radio-check" type="radio" name="star_level" value="4星级"<?php if($starLevel == '4星级'): ?>checked="checked"<?php endif; ?> >4星级</label>
                    <label style="margin-right: 15px;" for="3">
                        <input id="3" class="radio-check" type="radio" name="star_level" value="5星级" selected="selected" <?php if($starLevel == '5星级'): ?>checked="checked"<?php endif; ?>>5星级</label>
                    <label style="margin-right: 15px;" for="4">
                        <input id="4" class="radio-check" type="radio" name="star_level" value="无"  <?php if($starLevel == '无'): ?>checked="checked"<?php endif; ?>>无</label>
                </div>
            </div>
            <div class="form-group">
                <label>备注</label>
                <input type="text" class="form-control" name="remark" placeholder="备注..." value="<?php echo $hotel->remark; ?>">
            </div>
            <br>
            <div class="form-group">
